...
/**
 * Description of ControleCategoriaMenu
 *
 * @author ebiro_2
 */
    session_start();
    ...
    require_once($antes."modelo/ModelCategoriaMenu.php");
    $modelo    = new ModelCategoriaMenu();
    ...
    if(isset($_REQUEST["submit"])){
        ...
        if($submit !== "Procurar Nome" && $submit !== "Procurar"){
            ...
            if($submit === "Editar"){
                echo ("<script>location.href=('../visao/painel/CategoriaMenu.php?codcategoria=".$categoria->getCodcategoria()."&submit=Procurar');</script>");  
            }else{
                echo ("<script>location.href=('../visao/painel/CategoriaMenu.php?submit=Procurar Nome');</script>");  
            }
        } 
    }
