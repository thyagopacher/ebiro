 ...
 */
    ...
    if(isset($_REQUEST["submit"])){
        ...
        if($submit !== "Procurar Nome" && $submit !== "Procurar"){
            ...
            if($submit === "Editar"){
                echo ("<script>location.href=('../visao/painel/CategoriaProduto.php?codcategoria=".$categoria->getCodcategoria()."&submit=Procurar');</script>");  
            }else{
                echo ("<script>location.href=('../visao/painel/CategoriaProduto.php');</script>");  
            }
        }
    }
